      ...
      body: Stack(
        children: [
          ...
          Positioned(
              ...
              right: 0,
              child: Container(
                width: Dimensions.popularListSize,
                height: 350,
                decoration: BoxDecoration(
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage("assets/images/beermug1.png"))),
              )),
          //icon widgets
          Positioned(
          ...
          Positioned(
              ...
              right: 0,
              bottom: 0,
              top: Dimensions.popularListSize - 10,
              child: Container(
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.only(
                    ...
                    right: Dimensions.width20),
                child:
                    BigText(text: "\$1200 | Add to Cart", color: Colors.white),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(Dimensions.radius20),
